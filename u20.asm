...
l0846h:
	...
	ret			;0848	c9		.
sub_0849h:
	ld bc,l0001h		;0849	01 01 00	. . .
	ld hl,l0001h		;084c	21 01 00	! . .
...
l14a5h:
	...
	ld (de),a		;14a8	12		.
	inc de			;14a9	13		.
	call 01084h		;14aa	cd 84 10	. . .
	djnz l14a5h		;14ad	10 f6		. .
l14afh:
	pop af			;14af	f1		.
	ld (de),a		;14b0	12		.
	call 01084h		;14b1	cd 84 10	. . .
...
l1969h:
	...
	call 01084h		;1972	cd 84 10	. . .
	ld a,c			;1975	79		y
	call 01084h		;1976	cd 84 10	. . .
	ld a,005h		;1979	3e 05		> .
	call 01084h		;197b	cd 84 10	. . .
l197eh:
...
sub_1a0bh:
	...
	ld b,a			;1a0e	47		G
	call 01084h		;1a0f	cd 84 10	. . .
	call SOMETHING_KBD	;1a12	cd a7 17	. . .
	call 01084h		;1a15	cd 84 10	. . .
	ld c,a			;1a18	4f		O
...
sub_1ae6h:
	...
	call 01084h		;1afa	cd 84 10	. . .
	jr l1b0bh		;1afd	18 0c		. .
l1affh:
	push bc			;1aff	c5		.
	ld b,a			;1b00	47		G
	ld a,02ah		;1b01	3e 2a		> *
	call 01084h		;1b03	cd 84 10	. . .
	ld a,b			;1b06	78		x
...
l1f48h:
	...
	ld h,d			;1f88	62		b
	ld l,e			;1f89	6b		k
	ld bc,l0004h		;1f8a	01 04 00	. . .
	or a			;1f8d	b7		.
	sbc hl,bc		;1f8e	ed 42		. B
	ld bc,l001ch		;1f90	01 1c 00	. . .
	lddr			;1f93	ed b8		. .
	ld bc,l0004h		;1f95	01 04 00	. . .
...
sub_3480h:
	...
	ld bc,l0005h		;3488	01 05 00	. . .
	ldir			;348b	ed b0		. .
	ld hl,055d4h		;348d	21 d4 55	! . U
	ld bc,l0001h+2		;3490	01 03 00	. . .
	ldir			;3493	ed b0		. .
	ret			;3495	c9		.
sub_3496h:
...
sub_3ae0h:
	...
	call 01084h		;3af0	cd 84 10	. . .
	xor a			;3af3	af		.
	jr l3afbh		;3af4	18 05		. .
l3af6h:
	call 01084h		;3af6	cd 84 10	. . .
...
l3cc6h:
	...
	ldir			;3cd2	ed b0		. .
l3cd4h:
	ld iy,l0001h+2		;3cd4	fd 21 03 00	. ! . .
